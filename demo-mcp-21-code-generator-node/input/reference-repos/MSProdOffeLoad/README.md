...
## **Descripción**
Microservicio encargado de definir el listado de los precios, atributos, imágenes y el inventario de los productos disponibles para mostrar en la tienda Ecommerce v9.0.
...
```bash
# Clonar repositorio
$ git clone https://alminspiraclaro.visualstudio.com/Proyecto_EcommerceV9/_git/MSProdOffeLoad
