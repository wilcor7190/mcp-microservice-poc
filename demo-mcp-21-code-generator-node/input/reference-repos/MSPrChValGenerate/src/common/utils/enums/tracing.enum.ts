...
export enum ETaskTracingGeneral {
    ...
    GET_ALL_TERMS_CONDITIONS = "OBTIENE TODO LA DATA DE TERMS CONDITIONS",
...
export enum EDescriptionTracingGeneral {
    ...
    STA_PRICES_COLL_COLPRTPRODUCTOFFERING = "INICIO GUARDADO PRECIOS - COLL_COLPRTPRODUCTOFFERING",
    FIN_PRICES_COLL_COLPRTPRODUCTOFFERING = "FIN GUARDADO PRECIOS - COLL_COLPRTPRODUCTOFFERING",
    ...
    WRITE_FILE_CARAC = 'CREANDO ARCHIVO CARACTERISTICAS DESPUES DEL VOLCADO ',
